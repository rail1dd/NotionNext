...
const Footer = ({ title }) => {
  ...
  const copyrightDate = parseInt(since) < 2023 ? `2023-${currentYear}` : currentYear;
}
  ...
  return (
    ...
    >
      ...
      {BLOG.BEI_AN && <><i className='fas fa-shield-alt' /> <a href='https://icp.gov.moe/?keyword=20237755' className='mr-2'>{BLOG.BEI_AN}</a><br/></>}
      ...
      <span className='pl-2 hidden busuanzi_container_site_uv'>
        ...
        <p className='text-xs pt-2 text-light-500 dark:text-gray-500'>Powered by <a href='https://www.cloudflare-cn.com/' target='_blank'>Cloudflare</a> & <a href='https://vercel.com' target='_blank'>Vercel</a>.</p></span><br/>
