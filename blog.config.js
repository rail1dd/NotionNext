...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '99ff021749af48289a46131480cb2713',
  ...
  GREETING_WORDS:
    ...
    'Hi，Welcome to my blog ♡,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'rail1dd', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'ENFJ｜复古未来｜跨界融合｜自我探索', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://rail1dd.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blog,knowledge,self-extention', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || '', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || '', // Youtube主页
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yumm@rail1dd.ac.cn', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/rail1dd', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/rail1dd', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_WECHAT: process.env.NEXT_PUBLIC_CONTACT_WECHAT || 'https://pics-1318128484.cos.ap-nanjing.myqcloud.com/Wechat_QRcode.png', // 
  CONTACT_MUSIC: process.env.NEXT_PUBLIC_CONTACT_MUSIC || 'https://music.163.com/#/user?id=440336319', // 
  CONTACT_IM: process.env.NEXT_PUBLIC_CONTACT_IM || 'https://pics-1318128484.cos.ap-nanjing.myqcloud.com/Ming%20Y.vcf', // 
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20237755号', // 备案号 闽ICP备XXXXXXX
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '8189691987', // 对应歌单的 id
